...
//    }
    ...
    */
     ...
     * iterate through the elements in a set storing a cache of the elements to 
     * be iterated through, while also allowing the remove method to be able to 
     * actually remove an elements.
     * @param <E> The type of elements returned by this iterator.
     */
    private abstract class CacheSetIterator<E> implements Iterator<E>{
        /**
     ...
     * @param <V> 
     */
    private abstract class AbstractQueryRowMap<K,V> extends 
            AbstractSQLRowMap<K,V> {
        @Override
        ...
        protected String getRangeConditions(boolean fromStart, boolean fromInclusive, 
            ...
            if (fromStart)
                ...
                // If the range has a specified start and end
            else
                return conditions+getRangeConditions(fromInclusive,">") + 
                        " AND " + 
        ...
        protected String getRangeConditions(boolean fromStart, boolean fromInclusive, 
            ...
            return getRangeConditions(fromStart,fromInclusive,toEnd,toInclusive,false,null);
        }
        /**
         * 
        ...
        protected String getNavigableQuery(int comparison, boolean inclusive, 
            ...
            return getSortedQuery(
                    getRangeConditions(inclusive,operator)+conditions,
                    comparison < 0,1);
        }
        /**
         * 
        ...
        protected Entry<K, V> getNavEntry(K key,int comparison,boolean inclusive) 
            ...
            checkKey(key);  // Check the key
                ...
                // given key
            try(PreparedStatement pstmt = prepareStatement(getNavigableQuery(
        ...
        protected K getEndKeyForValue(V value, boolean last) throws SQLException{
            checkValue(value);  // Check the value
                ...
                // given value
            try(PreparedStatement pstmt = prepareStatement(getSortedQuery(
                    getValueCondition(value),last,1))){
        ...
        protected K getNavKeyForValue(V value, K key, int comparison, 
            ...
            try(PreparedStatement pstmt = prepareStatement(getNavigableQuery(
                    comparison,inclusive,getValueCondition(value)))){
                    // Set the key
                setPreparedKey(pstmt,1,key);
...
//                boolean toEnd, K toKey, boolean toInclusive) throws SQLException;
        ...
        protected int populateValueAndRange(PreparedStatement pstmt, 
                int parameterIndex,boolean fromStart, K fromKey, boolean toEnd, 
                K toKey, boolean useValue, V value)throws SQLException{
        ...
        protected int sizeSQL(boolean fromStart,K fromKey,boolean fromInclusive, 
                ...
                boolean useValue, V value)throws SQLException{
            ...
            if (fromStart && toEnd){
                ...
                if (useValue){
                    ...
                    return getTableSize(getTableName(), getKeyColumn());
...
//                        toEnd,toKey,toInclusive);
     ...
     * @param <E> 
     */
    private abstract class AbstractQueryList<E> extends AbstractSQLList<E>{
        @Override
        public LinkDatabaseConnection getConnection() throws SQLException {
            return LinkDatabaseConnection.this;
        }
        ...
        protected void replaceIndex(int index, E element) throws SQLException{
            ...
            try (PreparedStatement pstmt = prepareStatement(String.format(query, 
                    getTableName(),
                    getElementColumn(),
                    getTypeIDColumn(),
                    getIndexColumn()))){
        ...
        protected abstract int indexOfSQL(Object o, boolean descending) throws SQLException;
        /**
...
//            }
     ...
     * 
     */
    private class PrefixMapImpl extends AbstractQueryRowMap<Integer,String> 
...
//        }
     ...
     * 
     */
    private class LinkMapImpl extends AbstractQueryRowMap<Long,String> 
            implements LinkMap {
        /**
         * 
         */
...
//     * 
//     */
//    private class ListTypeMapImpl extends AbstractNavigableTypeIDMap<ListIDList>{
//        /**
//         * 
//         */
//        ListTypeMapImpl() {
...
//    }
     ...
     * 
     */
    private class ListContentsImpl extends AbstractQueryList<String> 
