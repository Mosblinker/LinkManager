...
//            if (!autoHideMenu.isRunning())
     ...
     */
    private void progressDisplayActionPerformed(java.awt.event.ActionEvent evt) {                                                
     ...
     * @param evt The ActionEvent.
     */
    private void alwaysOnTopToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                  
     ...
     * @param evt The ActionEvent.
     */
    private void doubleNewLinesToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                     
     ...
     * @param evt The ActionEvent.
     */
    private void linkOperationToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        updateSelectedLink();
     ...
     * @param evt The ActionEvent.
     */
    private void activeToggleActionPerformed(java.awt.event.ActionEvent evt) {                                             
     ...
     * @param evt The ActionEvent
     */
    private void printDataItemActionPerformed(java.awt.event.ActionEvent evt) {                                              
     ...
     * @param evt The ActionEvent.
     */
    private void dbViewItemActionPerformed(java.awt.event.ActionEvent evt) {                                           
     ...
     * @param evt The ActionEvent.
     */
    private void showIDsToggleActionPerformed(java.awt.event.ActionEvent evt) {                                              
        for (LinksListTabsPanel tabsPanel : listsTabPanels){
     ...
     * @param evt The ActionEvent.
     */
    private void dbRefreshButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                
     ...
     * @param evt The ActionEvent.
     */
    private void dbResetIDsButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        saver = new ResetDatabaseIDs();
        saver.execute();
    }                                                

    @SuppressWarnings("unchecked")
    private void addPrefixButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                
...
//            searchUsedPrefixes(conn,key);
    ...
    private void removePrefixButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
     ...
     * @param evt The ActionEvent.
     */
    private void executeQueryActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void setDBFileNameButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        setDatabaseFileName(dbFileNameField.getText());
        updateDatabaseFileFields();
    }                                                   

    private void resetDBFilePathButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        setDatabaseFileName(null);
        updateDatabaseFileFields();
    }                                                     

    private void backupDBButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
     ...
     * @param evt The ActionEvent
     */
    private void printDBButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        System.out.println("Database File Name: " + getDatabaseFileName());
...
//            System.out.println("Link Map: " + linkMap);
    ...
    private void dbCreateTablesButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        try(LinkDatabaseConnection conn = connect(getDatabaseFile());
            Statement stmt = conn.createStatement()){
    ...
    private void foreignKeysToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        config.getSQLiteConfig().enforceForeignKeys(foreignKeysToggle.isSelected());
    }                                                 

    private void updateDBFileButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    private void showDBErrorDetailsToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                         
     ...
     * @param evt The ActionEvent.
     */
    private void searchPanelActionPerformed(java.awt.event.ActionEvent evt) {                                            
     ...
     */
    private void searchPanelPropertyChange(java.beans.PropertyChangeEvent evt) {                                           
     ...
     * @param evt The ActionEvent
     */
    private void newLinkButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
     ...
     * @param evt The ActionEvent.
     */
    private void editLinkButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
     ...
     * @param evt The ActionEvent.
     */
    private void manageLinksButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
     ...
     * @param evt The ActionEvent.
     */
    private void removeLinkButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
            // If we can alter the currently selected list
        if (canActUponSelectedList()){ 
                // Get the currently selected list
            LinksListPanel selPanel = getSelectedList();
     ...
     * @param evt The ActionEvent
     */
    private void copyLinkButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
     ...
     * @param evt The ActionEvent.
     */
    private void openLinkButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void showHiddenListsToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                      
     ...
     */
    private void autosaveMenuActionPerformed(java.awt.event.ActionEvent evt) {                                             
     ...
     * @param evt 
     */
    private void autosaveMenuPropertyChange(java.beans.PropertyChangeEvent evt) {                                            
        switch(evt.getPropertyName()){
    ...
    private void listOpComboActionPerformed(java.awt.event.ActionEvent evt) {                                            
        updateListOperationButtons();
    }                                           

    private void listSetOpCancelButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        listSetOpDialog.setVisible(false);
    }                                                     

    private void listSetOpApplyButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
     ...
     * @param evt The ActionEvent.
     */
    private void listsTabsPanelPropertyChange(java.beans.PropertyChangeEvent evt) {                                              
     ...
     */
    private void listsTabsPanelStateChanged(javax.swing.event.ChangeEvent evt) {                                            
        updateButtons();
    }                                           
    /**
     ...
     */
    private void listsTabsPanelValueChanged(javax.swing.event.ListSelectionEvent evt) {                                            
    ...
    private void clearSelTabItemActionPerformed(java.awt.event.ActionEvent evt) {                                                
        for (LinksListTabsPanel tabsPanel : listsTabPanels){
            tabsPanel.setSelectedIndex(-1);
        }
    }                                               

    private void clearListSelItemActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void listSetOpItemActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void manageListsItemActionPerformed(java.awt.event.ActionEvent evt) {                                                
     ...
     * @param evt The ActionEvent.
     */
    private void updateDatabaseItemActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        saver = new DatabaseSaver();
        saver.execute();
    }                                                  
    /**
     ...
     * @param evt The ActionEvent.
     */
    private void updateListsItemActionPerformed(java.awt.event.ActionEvent evt) {                                                
        loadDatabase(false);
    }                                               
    /**
     ...
     * @param evt The ActionEvent.
     */
    private void reloadListsItemActionPerformed(java.awt.event.ActionEvent evt) {                                                
     ...
     * @param evt The ActionEvent.
     */
    private void exportListsItemActionPerformed(java.awt.event.ActionEvent evt) {                                                
    ...
    private void saveConfigItemActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void loadConfigItemActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void dbRemoveUnusedDataButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        try(LinkDatabaseConnection conn = connect(getDatabaseFile())){
     ...
     * @param evt The ActionEvent.
     */
    private void hiddenLinkOperationToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                          
        updateSelectedLink();
    ...
    private void showAllListsItemActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        setAllListVisible(true);
    }                                                

    private void hideAllListsItemActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        setAllListVisible(false);
    }                                                

    private void prefixApplyButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        try(LinkDatabaseConnection conn = connect(getDatabaseFile())){
     ...
     * @param evt The ActionEvent to process.
     */
    private void autoHideMenuActionPerformed(java.awt.event.ActionEvent evt) {                                             
     ...
     * @param evt 
     */
    private void autoHideMenuPropertyChange(java.beans.PropertyChangeEvent evt) {                                            
        switch(evt.getPropertyName()){
    ...
    private void dbUpdateUsedPrefixesButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                           
    ...
    private void dbListIDComboActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void dbListSizeLimitToggleActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        dbListSizeLimitSpinner.setEnabled(dbListSizeLimitToggle.isSelected());
    }                                                     

    private void dbListEditApplyButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        Integer listID = (Integer)dbListIDCombo.getSelectedItem();
    ...
    private void dbUsedPrefixSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
    ...
    private void prefixCopyButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        int selRow = dbPrefixTable.getSelectedRow();
        if (selRow < 0){
            JOptionPane.showMessageDialog(this, "No Prefix Selected",
                "No Prefix Selected", JOptionPane.WARNING_MESSAGE);
    ...
    private void dbRemoveDuplDataButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        try(LinkDatabaseConnection conn = connect(getDatabaseFile())){
...
//        config.setPropertyDefault(LINK_MANAGER_WINDOW_STATE_KEY, Integer.toString(JFrame.NORMAL));
    ...
    private void dbSearchPrefixCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        updateDBSearchPrefixCombo();
    }                                                      

    private void dbSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
        String prefixStr = dbUsedPrefixCombo.getSelectedItem().toString();
        try(LinkDatabaseConnection conn = connect(getDatabaseFile())){
    ...
    private void setDropboxTestButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
    ...
    private void dropboxRefreshTestButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
    ...
    private void setDBLocationItemActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void setDBCancelButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        setLocationDialog.setVisible(false);
    }                                                 
    
    private void setDBAcceptButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void setDBResetButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void dbFileBrowseButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    private void dbFileChangeComboActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        config.setProperty(DATABASE_FILE_CHANGE_OPERATION_KEY,dbFileChangeCombo.getSelectedIndex());
    }                                                 

    private void dbFileRelativeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        String fileName = dbFileField.getText();
        if (fileName != null)
            fileName = FilesExtended.removeQuotations(fileName);
        if (fileName == null || fileName.isBlank()){
...
//        System.out.println("Moved: " + evt);
     ...
     */
    private void setLocationDialogComponentResized(java.awt.event.ComponentEvent evt) {                                                   
            // Set the dialog's size in the config if it's saved
        config.setSizeProperty(setLocationDialog);
    }                                                  

    private void dbxPrintButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void dbxLogOutButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                
    ...
    private void dbxLogInButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
    ...
    private void uploadDBItemActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void downloadDBItemActionPerformed(java.awt.event.ActionEvent evt) {                                               
        if (isLoggedInToDropbox()){
    ...
    private void syncDBToggleActionPerformed(java.awt.event.ActionEvent evt) {                                             
        config.setProperty(SYNC_DATABASE_KEY,syncDBToggle.isSelected());
    }                                            

    private void dbUpdateLastModButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        try(LinkDatabaseConnection conn = connect(getDatabaseFile())){
            setDBLastModLabelText(conn.setDatabaseLastModified());
        }catch (SQLException | UncheckedSQLException ex) {
            System.out.println("Error: "+ex);
    ...
    private class CopyOrMoveLinks extends LinksListWorker<Void>{
        ...
        protected Void processLinks(LinksListPanel panel) {
            ...
            if (move && source != null && !source.isReadOnly()){
                    // If the whole source list has been added to the target
